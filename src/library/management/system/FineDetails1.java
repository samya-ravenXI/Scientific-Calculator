...
public class FineDetails1 extends JFrame implements ActionListener{
	...
	new FineDetails1().setVisible(true);
    }
	...
	JLabel l1 = new JLabel("Fine Details");
	...
	panel.setBorder(new TitledBorder(new LineBorder(new Color(95, 158, 160), 3, true), "Fine-Deatails",
    ...
    public void actionPerformed(ActionEvent ae){
        try{
            ...
            conn con = new conn();
            if( ae.getSource() == b1){
                String sql = "select * from fine where bname=?";
		PreparedStatement st = con.c.prepareStatement(sql);
