...
public class AddBook extends JFrame implements ActionListener{
	...
	panel.setBorder(new TitledBorder(new LineBorder(new Color(255, 0, 0), 2), "Add Books", TitledBorder.LEADING,
    ...
    public void actionPerformed(ActionEvent ae){
        try{
            conn con = new conn();
            if(ae.getSource() == b1){
                String sql = "insert into book(book_id, name, author, publisher, edition, price, pages) values(?, ?, ?, ?, ?, ?, ?)";
