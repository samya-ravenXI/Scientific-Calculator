...
public class Home extends JFrame implements ActionListener{
	...
	public static void main(String[] args) {
        ...
        public Home() {
            ...
            JMenuItem finedetails = new JMenuItem("Fine Details");
            finedetails.setBackground(new Color(211, 211, 211));
            finedetails.setForeground(Color.DARK_GRAY);
            finedetails.addActionListener(this);
            mnRecord.add(finedetails);
		...
		new BookDetails().setVisible(true);
            ...
            }else if(msg.equals("Fine Details")){
                setVisible(false);
