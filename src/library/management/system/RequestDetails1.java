...
public class RequestDetails1 extends JFrame implements ActionListener{
    ...
    public void student() {
        try {
            conn con = new conn();
            String sql = "select * from requestbook where student_id=?";
	...
	panel.setBorder(new TitledBorder(new LineBorder(new Color(95, 158, 160), 3, true), "Request-Deatails",
    ...
    public void actionPerformed(ActionEvent ae){
        try{
            ...
            conn con = new conn();
            if( ae.getSource() == b1){
                String sql = "select * from requestbook where name=?";
		PreparedStatement st = con.c.prepareStatement(sql);
		...
		st.close();
            ...
            if(ae.getSource() == b2){
                String sql = "delete from requestbook where name = '" + search.getText() + "'";
		PreparedStatement st = con.c.prepareStatement(sql);
